...
**구현 완료** (Step 0~4, 2026-04-17) + **사내 다중 사용자 전환** (2026-08-24: 매직링크 로그인, SQLite DB, 카카오 지오코딩). 지점 공유/전체공개 기능은 2026-08-25 제거 — 지점은 소유자 본인에게만 보임(완전 개인화). 실 기기 E2E 테스트(스마트폰 LAN) 일부 미검증. 지점 개별삭제(우클릭 메뉴)·전체삭제(좌패널 버튼, 둘 다 확인창 있음) 및 검색 결과 방향키+Enter 선택 추가(2026-08-25).
