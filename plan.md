...
**구현 완료 (2026-04-17)**. Step 0~4 모두 완료. 실 기기 E2E 테스트(스마트폰 LAN, T맵/카카오 딥링크, 인쇄) 일부 미수행.
...
- [ ] 검증: T맵/카카오 앱에서 경유지 포함 열림 (**실 기기 미수행**)
...
- [ ] 실제 카카오맵 경로 대비 총 시간 오차 10~30% 이내 (**실 기기 미수행**)
- [ ] 스마트폰 LAN 접속: 지도 롱프레스 메뉴, 탭 네비 동작 (**실 기기 미수행**)
- [ ] T맵/카카오 앱 딥링크 → 경유지 포함 열림 (**실 기기 미수행**)
- [x] 20개 경유지 → 카카오 버튼 비활성 + 툴팁
